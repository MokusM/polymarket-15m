...
from bot.position_manager import init_positions_table, init_pending_orders_table
...
async def main():
    ...
    if LIVE_TRADING and execution_client and execution_client.ready:
        from bot.position_manager import monitor_positions_loop, poll_pending_orders_loop
        tasks.append(asyncio.create_task(monitor_positions_loop(execution_client)))
        tasks.append(asyncio.create_task(poll_pending_orders_loop(execution_client)))
